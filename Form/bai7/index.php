...
<div class="form-bt">
        ...
        <div class="form">
            ...
            <div class="form-group">
                ...
                <div class="radio">
                    <label><input type="radio" name="optradio" value="%" s>Chia lấy dư</label>
                </div>
            </div>
        <div class="form-group">
            <div class="label-group">Số thứ nhất</div>
            <div> <input type="text"   name="so1" id="" class="form-control"  aria-describedby="helpId">           
            </div>
        </div>
        <div class="form-group">
            <div class="label-group">Số thứ hai</div>
            <div> <input type="text"  name="so2" id="" class="form-control"  aria-describedby="helpId">           
            </div>
        </div>
