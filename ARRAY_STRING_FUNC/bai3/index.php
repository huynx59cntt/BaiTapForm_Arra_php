<?php 
    $sophantu = $dayso = $min = $max = $tongdayso = "";
    $mang = array();
...
<div class="form-bt">
        ...
        <div class="form">
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" name="sophantu" id="" class="form-control" value="<?php  echo $sophantu; ?> " aria-describedby="helpId">
                </div> 
            </div>
            <button class="btn btn-danger" name="submit">
             ...
             <div class="form-group">
                ...
                <div>
                    <input type="text" name="dayso" readonly id="" class="form-control" value="<?php  echo $dayso; ?> " aria-describedby="helpId">
                </div> 
            </div>
            <div class="form-group">
                <div class="label-group"><label for="">GTLN (Max) trong mảng</label></div>
                <div>
                    <input type="text" name="max" readonly  id="" class="form-control" value="<?php  echo $max; ?> " aria-describedby="helpId">
                </div> 
            </div>
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" name="min"  readonly id="" class="form-control" value="<?php  echo $min; ?> " aria-describedby="helpId">
                </div> 
            </div>
        <div class="form-group">
